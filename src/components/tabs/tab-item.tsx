...
export function TabItem({
    ...
    return (
        <div
            className={cn(
                "tab-item group relative flex items-center gap-2 px-4 py-2.5 min-w-[180px] max-w-[220px] shrink-0 cursor-pointer transition-all duration-200",
                "border-r border-white/10",
                "hover:bg-white/5",
                isActive && "tab-item-active bg-linear-to-r from-purple-500/10 to-pink-500/10"
            )}
            onClick={onClick}
